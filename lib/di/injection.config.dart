...
import '../features/home/domain/usecases/get_categories.dart' as _i18;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i11.CredentialsLoginUseCase>(
        () => _i11.CredentialsLoginUseCase(gh<_i7.AuthRepository>()));
    gh.factory<_i12.RegisterUserUseCase>(
        () => _i12.RegisterUserUseCase(gh<_i7.AuthRepository>()));
    gh.factory<_i13.GoogleLoginUseCase>(
        () => _i13.GoogleLoginUseCase(gh<_i7.AuthRepository>()));
